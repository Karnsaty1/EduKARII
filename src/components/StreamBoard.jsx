...
const StreamBoard = () => {
  ...
  return (
    <div className='tools'>
      <h1 className='toolbar-header'>StreamBoard</h1>
      <div className='container-toolbar'>
        <div className="toolbar">
          <button onClick={() => handleToolChange('brush', 5)}>✒️</button>
          <button onClick={() => handleToolChange('pencil', 2)}>✏️</button>
          <button onClick={() => handleToolChange('eraser', 20)}>🧽</button>
        ...
        <video id="remoteVideo" autoPlay style={{ borderRadius: '50%', width: '150px', height: '150px' }}></video>
        <canvas ref={canvasRef} width="1600" height="800" ></canvas>
      </div>
    </div>
  );
};
